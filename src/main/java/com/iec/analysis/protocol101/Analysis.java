...
public class Analysis {
    ...
    public static String analysis(String messaage) throws LengthException, CustomException, UnknownLinkCodeException, UnknownTransferReasonException, UnknownTypeIdentifierException, IllegalFormatException {
        ...
        if (msgArray[0] == 0x68) {
            ...
            contentBuilder.append(Util.variableCS(CS, msgArray[length - 2]));
            ...
            contentBuilder.append("校验[5 byte]：").append(Util.variableCS(new int[]{msgArray[1], msgArray[2],
